...
![Kết nối UART trên Linux](../images/evidence-v2/01-linux-uart-connected.png)
...
![Xác thực Chế độ User Space](../images/evidence-v2/02-userspace-proof.png)
...
![Chu kỳ Khởi động Hoàn tất](../images/evidence-v2/03-complete-boot.png)
...
![Truy vấn Boot Log](../images/evidence-v2/04-boot-review.png)
...
![Cây Thiết bị & VFS](../images/evidence-v2/05-vfs-dtb.png)
...
![Bảng Tiến trình & Bộ nhớ](../images/evidence-v2/06-process-memory.png)
...
![Trình biên dịch tương tác Hala-C](../images/evidence-v2/07-hello-compiler.png)
...
![Kiểm soát Tiến trình Máy ảo](../images/evidence-v2/08-process-control.png)
...
![Ứng dụng Đa luồng song song](../images/evidence-v2/09-thread-app.png)
...
![Giao tiếp & Đồng bộ liên luồng](../images/evidence-v2/10-ipc.png)
...
![Pipe & POSIX API](../images/evidence-v2/11-pipe-posix.png)
...
![Đánh giá Bộ lập lịch](../images/evidence-v2/12-scheduler.png)
...
![Xử lý lỗi người dùng](../images/evidence-v2/13-fault.png)
...
![Lưu trữ ứng dụng qua Reset](../images/evidence-v2/14-persistence.png)
...
![Báo cáo Nghiệm thu cuối cùng](../images/evidence-v2/15-final-report.png)
...
![Kết thúc phiên làm việc](../images/evidence-v2/16-session-closed.png)

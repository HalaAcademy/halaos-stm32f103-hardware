...
![Kết nối UART trên Linux](../images/evidence/01-linux-uart-connected.png?v=2)
...
![Xác thực Chế độ User Space](../images/evidence/02-userspace-proof.png?v=2)
...
![Chu kỳ Khởi động Hoàn tất](../images/evidence/03-complete-boot.png?v=2)
...
![Truy vấn Boot Log](../images/evidence/04-boot-review.png?v=2)
...
![Cây Thiết bị & VFS](../images/evidence/05-vfs-dtb.png?v=2)
...
![Bảng Tiến trình & Bộ nhớ](../images/evidence/06-process-memory.png?v=2)
...
![Trình biên dịch tương tác Hala-C](../images/evidence/07-hello-compiler.png?v=2)
...
![Kiểm soát Tiến trình Máy ảo](../images/evidence/08-process-control.png?v=2)
...
![Ứng dụng Đa luồng song song](../images/evidence/09-thread-app.png?v=2)
...
![Giao tiếp & Đồng bộ liên luồng](../images/evidence/10-ipc.png?v=2)
...
![Pipe & POSIX API](../images/evidence/11-pipe-posix.png?v=2)
...
![Đánh giá Bộ lập lịch](../images/evidence/12-scheduler.png?v=2)
...
![Xử lý lỗi người dùng](../images/evidence/13-fault.png?v=2)
...
![Lưu trữ ứng dụng qua Reset](../images/evidence/14-persistence.png?v=2)
...
![Báo cáo Nghiệm thu cuối cùng](../images/evidence/15-final-report.png?v=2)
...
![Kết thúc phiên làm việc](../images/evidence/16-session-closed.png?v=2)
